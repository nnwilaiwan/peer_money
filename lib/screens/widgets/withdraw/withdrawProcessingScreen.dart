...
class WithdrawProcessingScreen extends StatefulWidget {
  static const String id = "WithdrawProcessingScreen";
  final void Function() onInit;

  const WithdrawProcessingScreen({Key? key, required this.onInit})
      : super(key: key);

  @override
  State<WithdrawProcessingScreen> createState() =>
      _WithdrawProcessingScreennState();
}

class _WithdrawProcessingScreennState extends State<WithdrawProcessingScreen> {
  @override
  void initState() {
    super.initState();
  }
